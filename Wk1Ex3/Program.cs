...
namespace Wk1Ex3
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // declare an int variable using a string to hold the user input for the prinicpal amount
            ...
            // declare an int variable using a string to hold the user input for the rate
